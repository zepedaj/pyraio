...
from jzf_datasets.vanilla_dataset.cython.read_input_iter cimport ReadInputIter, FilePosn
...
cdef class BlockManager:
    ...
    def __cinit__(self, int depth, int block_size):
        cdef int block_k
...
cdef class RAIOBatchReader:
    ...
    def iter(self, input_iter, long long default_ref=0, ref_map=None, dtype=None, shape=None):
        ...
        """
        cdef long fd
        cdef long long posn, ref=default_ref
